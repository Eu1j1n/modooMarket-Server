...
// 클라이언트에서 받은 receivedID 값
$receivedID = isset($_GET['receivedID']) ? $_GET['receivedID'] : '';

// 데이터베이스에서 좋아요한 게시물 가져오기
$sql = "SELECT image_uri, title, location, send_time, price, userName, description, saleType, bidPrice, deadLineDate, state, likes FROM posts WHERE FIND_IN_SET('$receivedID', likes)";
